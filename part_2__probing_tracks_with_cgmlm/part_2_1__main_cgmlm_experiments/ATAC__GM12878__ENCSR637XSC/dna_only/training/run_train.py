...
from local_utils.datasets.v2.with_nonpeak_sampling.masked_multimodal_input_dna_output_zarr_dataset import create_dataset
...
if __name__ == "__main__":
    ...
    config_dict.data.track_dataset_paths = [
        [
            "observed_tracks", 
