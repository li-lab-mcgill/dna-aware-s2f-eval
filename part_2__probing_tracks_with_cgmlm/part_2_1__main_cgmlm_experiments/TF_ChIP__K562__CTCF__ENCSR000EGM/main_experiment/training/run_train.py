...
if __name__ == "__main__":
    ...
    config_dict.task.experiment_dir = osp.join(
        ...
        "K562__CTCF__ENCSR000EGM",  # Updated cell line and experiment
        "ConditionalLM",
        "observed__main_experiment",  # Specify main experiment track
    ...
    config_dict.lightning.devices = [5] if torch.cuda.is_available() else 1  # Use 1 CPU device instead of None
