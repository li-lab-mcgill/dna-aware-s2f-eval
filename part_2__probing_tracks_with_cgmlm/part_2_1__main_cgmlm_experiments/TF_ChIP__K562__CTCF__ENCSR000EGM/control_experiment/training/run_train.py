...
if __name__ == "__main__":
    ...
    config_dict.task.cell_type = "K562"  # Updated for K562
    ...
    config_dict.data.peaks_zarr_path = osp.join(
        ...
        "K562__CTCF__ENCSR000EGM",  # Updated cell line and experiment
        "preprocessed",
        "zarr_datasets",
    ...
    # Control experiment tracks with +/- channels
    ...
    config_dict.task.experiment_dir = osp.join(
        ...
        "K562__CTCF__ENCSR000EGM",  # Updated cell line and experiment
        "ConditionalLM",
        "observed__control_experiment",  # Specify control experiment
    ...
    config_dict.lightning.devices = [9] if torch.cuda.is_available() else 1  # Use 1 CPU device instead of None
