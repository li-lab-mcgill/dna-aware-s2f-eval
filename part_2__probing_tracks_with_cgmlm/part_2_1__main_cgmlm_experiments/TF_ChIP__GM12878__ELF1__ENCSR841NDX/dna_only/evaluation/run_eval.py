...
def load_model(checkpoint_path, config_dict, device):
    """
    Load a dna only input dna only output model from a checkpoint.
    ...
    from local_utils.models.masked_unet.dna_input_dna_output import MaskedGenomeUNet
    # init model 
...
def evaluate_model_on_replicate(model, dataloader, config_dict):
    ...
    with torch.no_grad():
        for batch in tqdm(dataloader, desc="Processing batches", leave=False, disable=True):
            ...
            # For DNA only model we remove 
            # track related channels and mask channel entirely
            # from the input
...
if __name__ == "__main__":
    ...
    config_dict.task.model_names_and_checkpoints = {
        "10_to_20pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_0.1_to_0.2_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=36-step=3219.ckpt",
        "20_to_40pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_0.2_to_0.4_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=43-step=3828.ckpt",
        "40_to_60pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_0.4_to_0.6_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=39-step=3480.ckpt",
        "60_to_80pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_0.6_to_0.8_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=74-step=6525.ckpt",
        "80_to_100pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_0.8_to_1.0_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=13-step=1218.ckpt",
        "100pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/dna_only/fold_0/tiny__variable_rate_partial_row_mask__from_1.0_to_1.0_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=0-step=87.ckpt",
    }
    ...
    config_dict.eval.device = "cuda:9"
    config_dict.eval.batch_size = 2048
    ...
    # NOTE: Track dataset paths are there but they are not used for the dna only model
