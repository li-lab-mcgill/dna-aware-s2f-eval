...
if __name__ == "__main__":
    ...
    config_dict.task.cell_type = "GM12878"  # Changed from K562
    ...
    config_dict.data.peaks_zarr_path = osp.join(
        ...
        "data",
        "TF_ChIP",
        "GM12878__ELF1__ENCSR841NDX",  # Changed from K562__CTCF__ENCSR000EGM
        "preprocessed",
        "zarr_datasets",
    ...
    config_dict.data.peak_to_nonpeak_ratio = 3
    ...
    config_dict.data.max_shift = 100
