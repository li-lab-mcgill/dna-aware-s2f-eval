        ...
        for split_name in config_dict.task.split_names:
            ...
            for replicate_id in config_dict.eval.replicate_ids:
                ...
                for model_name, checkpoint_path in config_dict.task.model_names_and_checkpoints.items():
                    ...
                    nonpeaks_track_dataset_paths = \
                        [
                            [path.format(fold_name) if '{}' in path else path for path in track_path] 
                                for track_path in config_dict.data.nonpeaks_track_dataset_paths
                        ]
                    peaks_track_dataset_paths = \
                        [
                            [path.format(fold_name) if '{}' in path else path for path in track_path] 
                                for track_path in config_dict.data.peaks_track_dataset_paths
                        ]
                    ...
                    dataset = create_dataset(
                        ...
                        peaks_track_dataset_paths=peaks_track_dataset_paths,  # ← Format this
                        nonpeaks_track_dataset_paths=nonpeaks_track_dataset_paths,  # ← Format this
...
if __name__ == "__main__":
    ...
    config_dict.task.model_names_and_checkpoints = {
        "10_to_20pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_0.1_to_0.2_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_1/checkpoints/best_val_loss-epoch=141-step=12354.ckpt",
        "20_to_40pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_0.2_to_0.4_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=87-step=7656.ckpt",
        "40_to_60pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_0.4_to_0.6_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=114-step=10005.ckpt",
        "60_to_80pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_0.6_to_0.8_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=149-step=13050.ckpt",
        "80_to_100pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_0.8_to_1.0_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=107-step=9396.ckpt",
        "100pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/TF_ChIP/GM12878__ELF1__ENCSR841NDX/ConditionalLM/predicted__bpnetlite_without_control/fold_0/tiny__variable_rate_partial_row_mask__from_1.0_to_1.0_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=121-step=10614.ckpt",
    }
    ...
    config_dict.data.peaks_track_dataset_paths = [
        [
            ...
            "bpnet_without_control_predicted_track_summitcentered1000bp_symmetric100bpshift"  # Main experiment track
        ]
    ]
