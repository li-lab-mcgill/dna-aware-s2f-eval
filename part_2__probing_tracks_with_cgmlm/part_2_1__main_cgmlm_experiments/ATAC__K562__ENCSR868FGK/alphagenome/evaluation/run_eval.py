            ...
            for replicate_id in config_dict.eval.replicate_ids:
                ...
                for model_name, checkpoint_path in config_dict.task.model_names_and_checkpoints.items():
                    ...
                    dataset = create_dataset(
                        ...
                        peaks_track_dataset_paths=config_dict.data.peaks_track_dataset_paths,  # ← NO formatting 
...
if __name__ == "__main__":
    ...
    config_dict.task.model_names_and_checkpoints = {
        "10_to_20pct": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/ATAC/K562__ENCSR868FGK/ConditionalLM/alphagenome__predicted/fold_0/tiny__variable_rate_partial_row_mask__from_0.1_to_0.2_pct__p_dna_1.0__p_track_0.0__/DNA_1.0/lightning_logs/version_0/checkpoints/best_val_loss-epoch=95-step=37920.ckpt",
    ...
    config_dict.eval.device = "cuda:7"
