...
if __name__ == "__main__":
    ...
    config_dict.eval.device = "cuda:6"
    ...
    config_dict.data.peaks_track_dataset_paths = [
        [
            ...
            "chrombpnet_full_predicted_track_summitcentered1000bp_symmetric500bpshift"
        ]
    ]
