    ...
    for fold_name in config_dict.task.fold_names:
        ...
        for split_name in config_dict.task.split_names:
            ...
            for replicate_id in config_dict.eval.replicate_ids:
                ...
                # Double nested loop: outer for mask types, inner for resolutions
                for mask_type, resolution_dict in config_dict.task.model_names_and_checkpoints.items():
                    ...
                    for resolution_name, checkpoint_path in resolution_dict.items():
                        bin_width = int(resolution_name)  # Parse resolution as bin_width
                        print(f"\n-- Resolution {bin_width}x (mask: {mask_type}) --")

                        if checkpoint_path is None:
                            print(f"Skipping resolution {resolution_name} because checkpoint path is None")
                            continue

                        # Load model for this resolution
                        print(f"Loading model with resolution {bin_width}x from {checkpoint_path}")
                        ...
                        batch_preparer = BatchPreparer(
                            region_lengths=(-1,),  # FIXED: Always use full 1000bp
                            bin_width=bin_width,   # VARIABLE: Changes per resolution
                        ...
                        # Create dataset with matching mask type from outer loop
                        dataset = create_dataset(
                            ...
                            mask_type_str=mask_type,  # Use mask type from outer loop
                        ...
                        # Store metrics for this model in nested structure
...
if __name__ == "__main__":
    ...
    config_dict.task.model_names_and_checkpoints = {
        "10_to_20pct": {
            "1": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_1__count_equalization/chrombpnet__nobias_model__predicted/fold_0/mask_10to20pct/seed_42/lightning_logs/version_0/checkpoints/best_val_loss-epoch=126-step=60579.ckpt",
            "2": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_10to20pct/seed_42__resolution_2/lightning_logs/version_0/checkpoints/best_val_loss-epoch=57-step=27666.ckpt",
            "4": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_10to20pct/seed_42__resolution_4/lightning_logs/version_0/checkpoints/best_val_loss-epoch=57-step=27666.ckpt",
            "8": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_10to20pct/seed_42__resolution_8/lightning_logs/version_0/checkpoints/best_val_loss-epoch=64-step=31005.ckpt",
        },
        "100pct": {
            "1": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_1__count_equalization/chrombpnet__nobias_model__predicted/fold_0/mask_100pct/seed_42/lightning_logs/version_0/checkpoints/best_val_loss-epoch=21-step=10494.ckpt",
            "2": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_100pct/seed_42__resolution_2/lightning_logs/version_0/checkpoints/best_val_loss-epoch=14-step=7155.ckpt",
            "4": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_100pct/seed_42__resolution_4/lightning_logs/version_0/checkpoints/best_val_loss-epoch=13-step=6678.ckpt",
            "8": "/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_2__ConditionalLM_controlled_experiments/workspace/runs/ATAC/GM12878__ENCSR637XSC/ablation_2__resolution__shift_aug/chrombpnet__nobias_model__predicted/fold_0/mask_100pct/seed_42__resolution_8/lightning_logs/version_0/checkpoints/best_val_loss-epoch=12-step=6201.ckpt",
        }
    }
    ...
    # region_lengths will be fixed at (-1,) for all models (full 1000bp)
    # bin_width will be set per resolution in the loop (1, 2, 4, 8)
