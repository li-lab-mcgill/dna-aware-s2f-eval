...
if __name__ == "__main__":
    ...
    # Batch preparer configuration for evaluation (uses dataset-provided masks)
    config_dict.batch_preparer = ConfigDict()
    config_dict.batch_preparer.region_lengths = (-1,)  # use full track length
    ...
    # Instantiate batch preparer once (deterministic, uses precomputed masks from dataset)
