...
ASSAY_DATA_DIR="$BASE_DIR/ATAC/GM12878__ENCSR637XSC"
OUTPUT_DIR="/home/mcb/users/dcakma3/multi_res_bench_v2/multimodal_masked_contrastive_main/manuscript_experiments/section_1__ConditionalLM_as_diagnostic_probe/workspace/runs/ATAC/GM12878__ENCSR637XSC/S2F/bpnet/$FOLD_NAME"
mkdir -p "$OUTPUT_DIR"

# # ========= 7. Train ChromBPNet Model ========= #
echo "Running ChromBPNet single stage model training..."
chrombpnet single_stage_model__train \
    -ibw "$ASSAY_DATA_DIR/chrombpnet_annotation/ENCFF180XQC.bigWig" \
    -d "ATAC" \
