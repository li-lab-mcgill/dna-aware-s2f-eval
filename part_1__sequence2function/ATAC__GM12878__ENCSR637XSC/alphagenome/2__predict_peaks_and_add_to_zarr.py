...
def create_predicted_track_dataset(config_dict: ConfigDict):
    ...
    if dataset_name in target_group:
        raise ValueError(f"Dataset {dataset_name} already exists in fold_agnostic__model_based_tracks")
...
def main():
    ...
    config_dict.output_dir = os.path.join(
        ...
        "workspace", "data", "ATAC", "GM12878__ENCSR637XSC", "preprocessed", "zarr_datasets"
    )
