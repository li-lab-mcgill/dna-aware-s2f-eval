...
def load_models_for_fold(config_dict, fold_name):
    ...
    models['chrombpnet_full'] = ChromBPNet.from_chrombpnet(
        ...
        name=f"GM12878_ENCSR637XSC_ChromBPNet_{fold_name}"
    )
...
def main():
    ...
    config_dict.model.model_filepaths = {
        ...
        "chrombpnet_nobias": os.path.join(config_dict.model.model_dir, "ENCFF142IOR", "{}", "model.chrombpnet_nobias.{}.ENCSR637XSC.h5")
    }
