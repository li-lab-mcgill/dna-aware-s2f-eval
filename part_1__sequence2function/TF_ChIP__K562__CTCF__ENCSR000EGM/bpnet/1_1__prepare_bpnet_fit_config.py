...
data_dir = osp.join(
    ...
    "TF_ChIP/K562__CTCF__ENCSR000EGM",
    "preprocessed"
)
...
output_dir = osp.join(
	...
	"TF_ChIP/K562__CTCF__ENCSR000EGM/S2F/bpnetlite__with_control_track_input"
)
...
for fold_name in fold_names:
    ...
    bpnet_fit_with_controls = bpnet_fit_default.copy()
	# update the json 
    bpnet_fit_with_controls.update({
		"name": f"bpnet_with_controls__fit__{fold_name}",
    ...
    with open(filepath, 'w') as f:
          json.dump(bpnet_fit_with_controls, f, indent=4)
