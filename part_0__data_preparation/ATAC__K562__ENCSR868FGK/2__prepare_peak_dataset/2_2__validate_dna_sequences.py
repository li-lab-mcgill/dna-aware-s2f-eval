...
def validate_zarr_dataset(config_dict: ConfigDict):
    """Validate the combined zarr dataset by comparing with fresh extraction"""
    ...
    print(f"✓ peaks.all_folds.zarr PASSED")
    return True

def main():
    # Configuration - match 2_1 exactly
    ...
    # Validate the single zarr dataset
    print("Starting DNA sequence validation...")
    validate_zarr_dataset(config_dict)
    print(f"\n🎉 VALIDATION PASSED!")
